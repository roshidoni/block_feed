(function () {
  ...
  function runChecks() {
    ...
    const notificationBtn = document.querySelector("ytd-notification-topbar-button-renderer");
    if (notificationBtn) {
    ...
    if (path === "/") {
      ...
      if (feed) { // Check if already hidden
    ...
    if(window.location.pathname.startsWith("/watch")){
      const nextResults = document.querySelector("ytd-watch-next-secondary-results-renderer");
      if(nextResults){
